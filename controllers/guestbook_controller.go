...
import (
	...
	webappv1 "guestbook-4-16/api/v1"
)
...
func (r *GuestbookReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	newMinute := minute * *guestbook.Spec.MinuteMultiplier
	guestbook.Status.Minute = &newMinute
